...
from flow.benchmarks.straight_multilane_baseline import flow_params


def straight_multilane_baseline(num_runs):
    """Run script for all straight multilane baselines.
...
if __name__ == '__main__':
    ...
    res = straight_multilane_baseline(num_runs=runs)
