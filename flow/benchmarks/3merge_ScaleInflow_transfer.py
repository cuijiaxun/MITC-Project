...
from flow.envs import MergePOEnvScaleInflow,MergePOEnv_noheadway, TestEnv,Env
...
flow_params = dict(
    ...
    exp_tag="3merge_i696_ScaleInflow_horizon1500_wamrup0_SM9_inflow2000_merge200_depart10_noheadway_transfer",

    # name of the flow environment the experiment is running on
    #env_name=MergePOEnv,
    env_name=MergePOEnvScaleInflow,
