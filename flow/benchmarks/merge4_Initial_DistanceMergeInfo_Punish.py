...
- **Horizon**: 750 steps
"""
from flow.envs import MergePOEnvDistanceMergeInfo_Punish
...
flow_params = dict(
    ...
    exp_tag="merge_4_Sim_Number100_Initial_DistanceMergeInfo_Punish_RL10",

    # name of the flow environment the experiment is running on
    env_name=MergePOEnvDistanceMergeInfo_Punish,
