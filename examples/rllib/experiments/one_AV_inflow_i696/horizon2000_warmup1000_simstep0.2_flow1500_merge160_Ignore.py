...
from flow.envs import MergePOEnv,MergePOEnv_Ignore, TestEnv,Env
...
flow_params = dict(
    ...
    exp_tag="central_i696_IDMJunction_horizon2000_Ignore",

    # name of the flow environment the experiment is running on
    #env_name=MergePOEnv,
    env_name=MergePOEnv_Ignore,
...
if __name__ == "__main__":
    ...
    trials = run_experiments({
        flow_params["exp_tag"]: {
            ...
            "restore":'/home/flow/ray_results/central_i696_IDMJunction_horizon2000_Ignore/PPO_MergePOEnv_Ignore-v0_0_2020-04-25_13-49-44m7fk71uh/checkpoint_230',
            #"resume":True,
