...
from flow.envs import MergePOEnv_InflowScale,TestEnv,Env
...
flow_params = dict(
    ...
    exp_tag="central_i696_IDMJunction_horizon2000_InflowScale_depart20",

    # name of the flow environment the experiment is running on
    #env_name=MergePOEnv,
    env_name=MergePOEnv_InflowScale,
