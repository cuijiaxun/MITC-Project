...
from flow.envs import MergePOEnv_minV0R0
...
flow_params = dict(
    ...
    exp_tag="central_i696_IDMJunction_horizon2000_minV0R0_numRL20",

    # name of the flow environment the experiment is running on
    #env_name=MergePOEnv,
    env_name=MergePOEnv_minV0R0,
...
if __name__ == "__main__":
    ...
    trials = run_experiments({
        flow_params["exp_tag"]: {
            ...
            #"restore":"~/ray_results/central_i696_IDMJunction_4inflow_numRL20/PPO_MergePOEnv-v0_0_2020-04-18_23-26-01oth3e7wd/checkpoint_90/",
