...
from flow.envs import MergePOEnv,TestEnv,Env,MergePOEnv_noheadway_sumSpeed
...
flow_params = dict(
    ...
    exp_tag="central_i696_IDMJunction_horizon2000_noheadway_sumSpeed",

    # name of the flow environment the experiment is running on
    #env_name=MergePOEnv,
    env_name=MergePOEnv_noheadway_sumSpeed,
