...
from flow.envs.multiagent import MultiAgentHighwayPOEnvMerge4Negative
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_Merge4_Negative',

    env_name=MultiAgentHighwayPOEnvMerge4Negative,
