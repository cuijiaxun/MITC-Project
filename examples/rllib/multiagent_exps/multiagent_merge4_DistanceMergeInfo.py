...
from flow.envs.multiagent import MultiAgentHighwayPOEnvDistanceMergeInfo
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_DistanceMergeInfo',

    env_name=MultiAgentHighwayPOEnvDistanceMergeInfo,
