...
from flow.envs.multiagent import MultiAgentHighwayPOEnvDistanceMergeInfoCollaborate
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_DistanceMergeInfo_Collaborate',

    env_name=MultiAgentHighwayPOEnvDistanceMergeInfoCollaborate,
