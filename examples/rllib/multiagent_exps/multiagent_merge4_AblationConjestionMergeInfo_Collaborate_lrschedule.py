...
from flow.envs.multiagent import MultiAgentHighwayPOEnvAblationConjestionMergeInfoCollaborate
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_AblationConjestionMergeInfo_Collaborate_lr_schedule_eta1_{}_eta2_{}'.format(ETA_1, ETA_2),

    env_name=MultiAgentHighwayPOEnvAblationConjestionMergeInfoCollaborate,
