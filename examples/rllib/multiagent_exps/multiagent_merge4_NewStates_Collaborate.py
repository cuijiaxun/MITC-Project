...
from flow.envs.multiagent import MultiAgentHighwayPOEnvNewStatesCollaborate
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_NewStates_Collaborate',

    env_name=MultiAgentHighwayPOEnvNewStatesCollaborate,
...
def setup_exps(flow_params):
    ...
    config['sgd_minibatch_size'] = 4000
    #config['simple_optimizer'] = True
    config['gamma'] = 1  # discount rate
    config['model'].update({'fcnet_hiddens': [16, 32, 32]})
    config['lr'] = tune.grid_search([5e-4,3e-4])
