...
from flow.envs.multiagent import MultiAgentHighwayPOEnvNewStatesNegativeInflow
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_NewStates_Negative_Inflow',

    env_name=MultiAgentHighwayPOEnvNewStatesNegativeInflow,
