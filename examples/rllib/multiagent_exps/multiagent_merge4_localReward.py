...
from flow.envs.multiagent import MultiAgentHighwayPOEnvLocalReward
...
flow_params = dict(
    exp_tag='multiagent_highway_merge4_LocalReward',

    env_name=MultiAgentHighwayPOEnvLocalReward,
