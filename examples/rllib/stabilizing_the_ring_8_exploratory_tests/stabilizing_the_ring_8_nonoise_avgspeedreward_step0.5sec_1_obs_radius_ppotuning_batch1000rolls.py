...
flow_params = dict(
    ...
    exp_tag="stabilizing_the_ring_8_nonoise_avgspeedreward_step0.5sec_1_obs_radius_ppotuning_batch1000rolls",

    # name of the flow environment the experiment is running on
    env_name="WaveAttenuationPORadius1Env",
...
def setup_exps():
    ...
    config["vf_loss_coeff"] = 0 #default was 1, why use it at all? use vf loss when fitting advantage not when improving policy
