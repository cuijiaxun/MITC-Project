...
N_ROLLOUTS = 1 #20# 1000
# number of parallel workers
N_CPUS = 1 #8

######## :ODO REMOVE LISTENING TO SIGNAL FOR STACK TRACE
...
flow_params = dict(
    ...
    exp_tag="stabilizing_the_ring_8_nonoise_avgspeedreward_step0.5sec_1_obs_radius_ppotuning_batch20rolls_with_vf_loss_batch_diagnostic",
